...
fanlin_only()
        ...
        uci set fastd.mesh_vpn_backbone_peer_sn_fanlin_1.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_fanlin_2.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_c1024.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_fussel.enabled=0
 ...
 fanlin1_only()
        ...
        uci set fastd.mesh_vpn_backbone_peer_sn_fanlin_1.enabled=1
        uci set fastd.mesh_vpn_backbone_peer_sn_fanlin_2.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_c1024.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_fussel.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_parad0x.enabled=0
 ...
 fanlin2_only()
        ...
        uci set fastd.mesh_vpn_backbone_peer_fanlin.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_fanlin_1.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_fanlin_2.enabled=1
        uci set fastd.mesh_vpn_backbone_peer_c1024.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_fussel.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_parad0x.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sense.enabled=0
...
commander1024_only()
        ...
        uci set fastd.mesh_vpn_backbone_peer_sn_fanlin_1.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_fanlin_2.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_c1024.enabled=1
        uci set fastd.mesh_vpn_backbone_peer_fussel.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_parad0x.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sense.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_kgbvax_1.enabled=0
...
fusselkater_only()
        ...
        uci set fastd.mesh_vpn_backbone_peer_sn_fanlin_2.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_c1024.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_fussel.enabled=1
        uci set fastd.mesh_vpn_backbone_peer_parad0x.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sense.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_kgbvax_1.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_kgbvax_2_a.enabled=0
...
kgbvax1_only()
        ...
        uci set fastd.mesh_vpn_backbone_peer_parad0x.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sense.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_kgbvax_1.enabled=1
        uci set fastd.mesh_vpn_backbone_peer_sn_kgbvax_2_a.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_kgbvax_2_b.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_descilla_1.enabled=0
        }
...
kgbvax2a_only()
        ...
        uci set fastd.mesh_vpn_backbone_peer_sense.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_kgbvax_1.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_kgbvax_2_a.enabled=1
        uci set fastd.mesh_vpn_backbone_peer_sn_kgbvax_2_b.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_descilla_1.enabled=0
        }
...
kgbvax2b_only()
        ...
        uci set fastd.mesh_vpn_backbone_peer_sn_kgbvax_1.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_kgbvax_2_a.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_kgbvax_2_b.enabled=1
        uci set fastd.mesh_vpn_backbone_peer_sn_descilla_1.enabled=0
        }
...
descilla1_only()
        ...
        uci set fastd.mesh_vpn_backbone_peer_sn_kgbvax_2_a.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_kgbvax_2_b.enabled=0
        uci set fastd.mesh_vpn_backbone_peer_sn_descilla_1.enabled=1
        }
